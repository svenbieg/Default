...
namespace std
{
template <class _char_t> struct is_character
	{
...
template <> struct is_character<WCHAR>
	{
	static constexpr bool value=true;
	};
...
public:
	...
	static inline BOOL Equal(CHAR Char1, CHAR Char2)noexcept
		{
		return Char1==Char2;
		}
	...
	static inline BOOL Equal(WCHAR Char1, WCHAR Char2)noexcept
		{
		return Char1==Char2;
		}
	...
	static inline BOOL IsDigit(CHAR Char, UINT Base=10)noexcept
		{
		return ToDigit(Char, nullptr, Base);
		}
	static inline BOOL IsDigit(WCHAR Char, UINT Base=10)noexcept
		{
		return ToDigit(Char, nullptr, Base);
		}
	...
	static inline UINT Read(LPCSTR String)
		{
		return Read(String, (WCHAR*)nullptr);
		}
	...
	static inline  UINT Read(InputStream* Stream)
		{
	...
	static inline CHAR ToChar(CHAR Char)noexcept
		{
		return Char;
		}
	...
	static inline WCHAR ToCharW(WCHAR Char)noexcept
		{
		return Char;
		}
...
template <> inline CHAR CharHelper::ToCapitalT(CHAR Char)noexcept
{
return ToCapital(Char);
}

template <> inline CHAR CharHelper::ToCapitalT(WCHAR Char)noexcept
{
return ToCapital(Char);
}

template <> inline WCHAR CharHelper::ToCapitalT(CHAR Char)noexcept
{
return ToCapitalW(Char);
}

template <> inline WCHAR CharHelper::ToCapitalT(WCHAR Char)noexcept
{
return ToCapitalW(Char);
}

template <> inline CHAR CharHelper::ToCharT(CHAR Char)noexcept
{
return Char;
}

template <> inline CHAR CharHelper::ToCharT(WCHAR Char)noexcept
{
return ToChar(Char);
}

template <> inline WCHAR CharHelper::ToCharT(CHAR Char)noexcept
{
return ToCharW(Char);
}

template <> inline WCHAR CharHelper::ToCharT(WCHAR Char)noexcept
{
return Char;
}

template <> inline CHAR CharHelper::ToSmallT(CHAR Char)noexcept
{
return ToSmall(Char);
}

template <> inline CHAR CharHelper::ToSmallT(WCHAR Char)noexcept
{
return ToSmall(Char);
}

template <> inline WCHAR CharHelper::ToSmallT(CHAR Char)noexcept
{
return ToSmallW(Char);
}

template <> inline WCHAR CharHelper::ToSmallT(WCHAR Char)noexcept
{
return ToSmallW(Char);
}
